...
## <b id="init(string,string,string,string)🇼">init(string,string,string,string)🇼</b>
- **描述**: 初始化合约
...
## <b id="mint(address)🇼">mint(address)🇼</b>
- **描述**:  铸造NFT
...
## <b id="safeMint(address)🇼">safeMint(address)🇼</b>
- 描述: 
...
## <b id="safeMint(address,uint256)🇼">safeMint(address,uint256)🇼</b>
- 描述: 
...
## <b id="setBaseURI(string)🇼">setBaseURI(string)🇼</b>
- **描述**: 更改metadata的目录URL
...
## <b id="setDetailsURI(string)🇼">setDetailsURI(string)🇼</b>
- 描述: 
...
## <b id="setParty(string[],uint8[])🇼">setParty(string[],uint8[])🇼</b>
- 描述: 
...
## <b id="suspend(bool)🇼">suspend(bool)🇼</b>
- 描述: 
...
*updated: 2024-10-05 10:25:45    i̧͎̩̦̯͓͓͔̯̦̭s͖̰̫͈̬͕̱̠͜o̖̗̩̬̥͖͕̝͢t̢͖̤̙̲o̪͉͕̲͔͉͈̥͕͜p̘̞͎̪̩̤͓͢*
